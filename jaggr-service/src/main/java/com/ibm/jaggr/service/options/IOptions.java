...
public interface IOptions {
	...
	/**
	 * Name of property that specifies if the aggregator should gzip responses.
	 * This property is useful when the aggregator is running behind reverse
	 * proxies that handle this sort of thing.
	 * <p>
	 * Valid values: <code>true/false</code>
	 * Default: <code>false</code>
	 */
	public static final String DISABLE_GZIPCOMPRESSION = "disableGzipCompression"; //$NON-NLS-1$
	...
	/**
	 * Convenience method for reading the {@link #DISABLE_GZIP_COMPRESSION}
	 * options property.
	 *
	 * @return The value of the {@link #DISABLE_GZIP_COMPRESSION} option.
   	 */
