...
public class Messages extends NLS {
	...
	public static String RequireExpansionCompilerPass_11;
	public static String RequireExpansionCompilerPass_2;
	public static String RequireExpansionCompilerPass_6;
	public static String RequireExpansionCompilerPass_7;
	public static String RequireExpansionCompilerPass_8;
	public static String RequireExpansionCompilerPass_9;
	static {
