...
public class ResolverResourceTest {
	...
	public void testResolve() throws Exception {
		...
		ResolverResource relativeResource = new ResolverResource(new FileResource(relativeFileUri),  relativeBundleUri);
		...
		ResolverResource res = new ResolverResource(new FileResource(fileUri), bundleUri);
		URI resolved = res.resolve("../relative");
