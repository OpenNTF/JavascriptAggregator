...
public class DepUtilsTest {
	/**
	 * Test method for {@link com.ibm.jaggr.core.deps.impl.DepUtils#removeRedundantPaths(java.util.Collection)}.
	...
	/**
	 * Test method for {@link com.ibm.jaggr.core.deps.impl.DepUtils#getNodeForResource(java.lang.String, java.util.Map)}.
	 * @throws URISyntaxException 
	 */
	@Test
	...
	/**
	 * Test method for {@link com.ibm.jaggr.core.deps.impl.DepUtils#parseDependencies(com.google.javascript.rhino.Node)}.
	 */
	@Test
	public void testParseDependencies() {
		...
		deps = DepUtils.parseDependencies(node);
		assertEquals(deps.toString(), "[a, b, c]");
